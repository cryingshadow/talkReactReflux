...
\newcommand{\insertauthorpic}{\includegraphics[width=1.446cm]{philip.png}\includegraphics[width=1.446cm]{thomas.png}}
\newcommand{\footertext}{%
  \fontsize{5}{5}\selectfont\begin{minipage}{3mm}\vspace*{-1pt}\raggedleft\insertframenumber\end{minipage}\hspace*{3mm}
  © METRO AG.\hspace*{3mm}\insertshortauthor{}: \inserttitle{}
}
